const copy = {
  fr: {
    ...
    why: {
      ...
      brand: 'Norgesco',
      lead: 'Peu importe le projet — revêtement, portes et fenêtres, sous-sol, cuisine ou salle de bain. Une équipe de confiance pour vos rénovations résidentielles.',
    ...
    reviews: {
      ...
      items: [
        {
          name: 'Sophie L.',
          text: 'Travail impeccable sur notre revêtement. Équipe professionnelle, ponctuelle et à l’écoute. On recommande sans hésiter.',
        },
        {
          name: 'Marc D.',
          text: 'Excellent suivi du début à la fin. Portes et fenêtres installées proprement, résultat exact à ce qui avait été promis.',
        },
        {
          name: 'Isabelle R.',
          text: 'Rénovation de notre salle de bain faite avec beaucoup de soin. Communication claire et chantier bien tenu.',
        },
      ],
    },
    footer: {
  ...
  en: {
    ...
    why: {
      title: 'Why choose',
      brand: 'Norgesco',
      lead: 'Whatever the project — siding, doors and windows, basement, kitchen, or bathroom. A trusted team for your residential renovations.',
    ...
    reviews: {
      ...
      items: [
        {
          name: 'Sophie L.',
          text: 'Impeccable work on our siding. Professional, punctual, and attentive team. We recommend them without hesitation.',
        },
        {
          name: 'Marc D.',
          text: 'Excellent follow-through from start to finish. Doors and windows installed cleanly — exactly as promised.',
        },
        {
          name: 'Isabelle R.',
          text: 'Our bathroom renovation was done with great care. Clear communication and a well-kept job site.',
        },
      ],
    },
    footer: {
...
function applyStaticCopy() {
  ...
  const circles = document.getElementById('why-circles')
  if (circles) {
    circles.innerHTML = dict.why.circles
      .map((label) => `<div class="why-circle">${label}</div>`)
      .join('')
  }
